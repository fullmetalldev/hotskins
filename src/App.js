    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route path="/cart" element={<CartPage setCart={setCart} cart={cart} allSum={allSum} language={language}/>}/>
                <Route path="/contacts" element={<Contacts language={language}/>}/>
                <Route path="/case" element={<CasePage setCart={setCart} cart={cart} csgoCards={csgoCards} language={language}/>}/>
            </Routes>
